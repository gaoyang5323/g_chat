package com.kakuiwong.httpserver.httpconfig.intercepter;

import com.alibaba.fastjson.JSON;
import com.kakuiwong.model.annotation.AnonymousLogin;
...
public class AppAuthInterceptor implements HandlerInterceptor {
    ...
    private String checkAuth(HttpServletRequest request) {
        ...
        //验证token
        LoginResultVO loginResultVO = null;//= WebsocketAuthServiceImpl.userIdTokenMap.get(userId);
